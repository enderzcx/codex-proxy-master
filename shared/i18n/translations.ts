export const translations = {
  en: {
    ...
    requestHistoryDesc: "Per-request metadata ledger for recent API calls.",
    requestHistorySearch: "Search request ID, response ID, model, or account...",
    requestHistoryTime: "Time",
    requestHistoryEndpoint: "Endpoint",
    requestHistoryModel: "Model",
    requestHistoryAccount: "Account",
    requestHistoryDuration: "Duration",
    requestHistoryOutcome: "Outcome",
    requestHistoryRequestId: "Request ID",
    requestHistoryOutcomeSuccess: "Success",
    requestHistoryOutcomeError: "Error",
    requestHistoryOutcomeAborted: "Aborted",
    requestHistoryAttempts: "Attempts",
    requestHistoryEmpty: "No request history yet",
    requestHistoryAllPaths: "All Endpoints",
    requestHistoryClientIp: "Client IP",
    requestHistoryUserAgent: "User Agent",
    requestHistoryReqSize: "Req Size",
    requestHistoryRespSize: "Resp Size",
    requestHistoryFingerprint: "Fingerprint",
    requestHistoryExpandRow: "Show network details",
    requestHistoryCollapseRow: "Hide network details",
    requestHistoryDetailsTitle: "Network details",
  ...
  zh: {
    ...
    cancel: "取消",
    usageStats: "用量统计",
    requestHistoryTitle: "请求明细",
    requestHistoryDesc: "记录近期每次 API 请求的元数据明细。",
    requestHistorySearch: "搜索请求 ID、响应 ID、模型或账号...",
    requestHistoryTime: "时间",
    requestHistoryEndpoint: "Endpoint",
    requestHistoryModel: "模型",
    requestHistoryAccount: "账号",
    requestHistoryDuration: "耗时",
    requestHistoryOutcome: "结果",
    requestHistoryRequestId: "请求 ID",
    requestHistoryOutcomeSuccess: "成功",
    requestHistoryOutcomeError: "错误",
    requestHistoryOutcomeAborted: "中断",
    requestHistoryAttempts: "尝试次数",
    requestHistoryEmpty: "暂无请求明细",
    requestHistoryAllPaths: "全部端点",
    requestHistoryClientIp: "客户端 IP",
    requestHistoryUserAgent: "User Agent",
    requestHistoryReqSize: "请求大小",
    requestHistoryRespSize: "响应大小",
    requestHistoryFingerprint: "指纹",
    requestHistoryExpandRow: "展开网络详情",
    requestHistoryCollapseRow: "收起网络详情",
    requestHistoryDetailsTitle: "网络详情",
